    ...
    items: [
      {
        id: "dashboard",
        label: "Dashboard",
        href: "/accubridge/client/dashboard",
        icon: <LayoutDashboard size={18} />,
      },
      {
        id: "transactions",
        label: "Transactions",
        href: "/accubridge/client/transactions",
        icon: <ArrowLeftRight size={18} />,
      },
      {
        id: "reconciliation",
        label: "Reconciliation",
        href: "/accubridge/client/transactions/reconciliation",
      ...
      },
      {
        ...
        subItems: [
          { label: "Profit & Loss",    href: "/accubridge/client/reports/pnl",      icon: <TrendingUp size={14} /> },
          { label: "Balance Sheet",    href: "/accubridge/client/reports/balance",  icon: <DollarSign size={14} /> },
          { label: "Cash Flow",        href: "/accubridge/client/reports/cashflow", icon: <CreditCard size={14} /> },
          { label: "Download Reports", href: "/accubridge/client/reports/download", icon: <Download size={14} /> },
        ],
      },
      {
        id: "compliance",
        label: "Compliance Passport",
        href: "/accubridge/client/compliance",
      ...
      },
      {
        ...
        subItems: [
          { label: "Raffle Funding",    href: "/accubridge/client/funding/raffle",     icon: <Ticket size={14} />     },
          { label: "Compliance Grants", href: "/accubridge/client/funding/compliance",  icon: <ShieldCheck size={14} /> },
          { label: "Investor Pitch",    href: "/accubridge/client/funding/investor",    icon: <TrendingUp size={14} />  },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        href: "/accubridge/client/ai-ideas",
      ...
      },
      {
        ...
        href: "/accubridge/client/registration",
    ...
    items: [
      {
        id: "settings",
        label: "Settings",
        href: "/accubridge/client/settings",
