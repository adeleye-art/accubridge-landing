...
const STAFF_NAV: NavSection[] = [
  {
    title: "Main",
    items: [
      { id: "dashboard",    label: "Dashboard",    href: "/staff/dashboard",    icon: <LayoutDashboard size={18} /> },
      { id: "clients",      label: "My Clients",   href: "/staff/clients",      icon: <Users size={18} /> },
      { id: "transactions", label: "Transactions", href: "/staff/transactions", icon: <ArrowLeftRight size={18} /> },
      { id: "reports",      label: "Reports",      href: "/staff/reports",      icon: <BarChart3 size={18} /> },
  ...
  },
  {
    title: "Account",
    items: [
      { id: "settings", label: "Settings", href: "/staff/settings", icon: <Settings size={18} /> },
    ],
  },
];
