...
const ADMIN_NAV: NavSection[] = [
  {
    title: "Main",
    items: [
      { id: "dashboard",    label: "Dashboard",      href: "/admin/dashboard",    icon: <LayoutDashboard size={18} /> },
      { id: "clients",      label: "Clients",        href: "/admin/clients",      icon: <Users size={18} /> },
      { id: "transactions", label: "Transactions",   href: "/admin/transactions", icon: <ArrowLeftRight size={18} /> },
      { id: "reports",      label: "Reports",        href: "/admin/reports",      icon: <BarChart3 size={18} /> },
      { id: "compliance",   label: "Compliance",     href: "/admin/compliance",   icon: <ShieldCheck size={18} /> },
    ],
  },
  {
    title: "Admin",
    items: [
      { id: "staff",   label: "Staff Management", href: "/admin/staff",   icon: <UserCog size={18} /> },
      { id: "funding", label: "Funding Queue",    href: "/admin/funding", icon: <Landmark size={18} />, badge: "3", badgeColor: BRAND.gold },
      { id: "logs",    label: "Activity Logs",    href: "/admin/logs",    icon: <ScrollText size={18} /> },
    ],
  },
  {
    title: "Account",
    items: [
      { id: "settings", label: "Settings", href: "/admin/settings", icon: <Settings size={18} /> },
    ],
  },
];
