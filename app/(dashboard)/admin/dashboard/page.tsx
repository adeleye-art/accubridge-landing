  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0A2463] to-[#0D0D0D] text-white p-8">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          <div className="inline-block border border-white/10 rounded-lg px-3 py-1 text-xs text-[#6B7280] mb-3">Super Admin</div>
          <h1 className="text-3xl font-bold tracking-tight mb-1">Admin Dashboard</h1>
          <p className="text-[#6B7280]">Full platform control — clients, staff, compliance, and funding.</p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            ...
            { label: "Assign Accountant",   href: "/admin/assign",     icon: "🔗" },
            { label: "Review Documents",    href: "/admin/documents",  icon: "📄" },
            { label: "Review Funding",      href: "/admin/funding",    icon: "💼" },
            { label: "Manage Staff",        href: "/admin/staff",      icon: "🤝" },
            { label: "Platform Settings",   href: "/admin/settings",   icon: "⚙️" },
            { label: "Compliance Overview", href: "/admin/compliance", icon: "🛡️" },
