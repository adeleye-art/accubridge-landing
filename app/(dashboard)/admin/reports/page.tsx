...
const ALL_CLIENTS = [
  ...
  "TechBridge NG Ltd", "Lagos First Capital", "Greenfield Ventures",
];
...
const RECENT_REPORTS = [
  { client: "Apex Solutions Ltd",  type: "Profit & Loss",  generated_by: "Mark Chen",    date: "3 Apr 2026" },
  { client: "Bright Path Ltd",     type: "Balance Sheet",  generated_by: "Priya Sharma", date: "2 Apr 2026" },
  { client: "Nova Consulting UK",  type: "Cash Flow",      generated_by: "Admin",         date: "1 Apr 2026" },
  { client: "TechBridge NG Ltd",   type: "Profit & Loss",  generated_by: "Mark Chen",    date: "31 Mar 2026" },
];

export default function AdminReportsPage() {
  const [selectedClient, setSelectedClient] = useState(ALL_CLIENTS[0]);
    ...
    <div className="p-5 md:p-8 text-white">
      <div className="max-w-5xl mx-auto flex flex-col gap-6">
        ...
        <div>
          ...
          <p className="text-sm mt-0.5" style={{ color: BRAND.muted }}>Generate financial reports for any client account.</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {REPORT_TYPES.map((r) => (
            <div key={r.id} className="rounded-2xl p-5 border flex flex-col gap-4" style={{ backgroundColor: "rgba(255,255,255,0.04)", borderColor: "rgba(255,255,255,0.08)" }}>
              <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ backgroundColor: `${r.color}18`, color: r.color }}>
                {r.icon}
              </div>
              <div>
              ...
              <button
                type="button"
                onClick={() => handleGenerate(r.id, r.label)}
            ...
            <table className="w-full text-sm">
              <thead>
                <tr style={{ borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
                  {["Client", "Report Type", "Generated By", "Date", "Download"].map((h) => (
              ...
              <tbody>
                {RECENT_REPORTS.map((r, i) => (
                  <tr key={i} className="hover:bg-white/[0.02] transition-colors" style={{ borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
                    ...
                    <td className="px-5 py-3.5" style={{ color: BRAND.muted }}>{r.generated_by}</td>
