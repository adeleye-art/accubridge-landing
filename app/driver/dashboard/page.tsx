  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      <div className="bg-surface rounded-2xl border border-surface-dark shadow-sm p-10 max-w-md w-full text-center space-y-5">
        ...
        <div>
          <p className="text-xs uppercase tracking-widest text-text-muted mb-1">Driver Portal</p>
        ...
        <div className="bg-background rounded-xl p-6 border border-surface-dark">
          ...
          <p className="text-sm text-text-secondary mt-1">
            The driver dashboard is under construction. Full implementation coming in the next phase.
          </p>
        </div>
      </div>
    </div>
