...
import type { ApiReconciliationLine } from "@/lib/accubridge/api/reconciliationApi";
...
export default function ReconciliationDetailPage() {
  ...
  async function handleFinalize() {
    ...
    if ("data" in result && result.data) {
      ...
      setTimeout(() => router.push("/accubridge/client/transactions/reconciliation"), 1000);
  ...
  if (isError || !detail) {
    return (
      <div className="p-8 flex flex-col items-center gap-3 text-white">
        ...
        <button
          type="button"
          onClick={() => router.push("/accubridge/client/transactions/reconciliation")}
