...
import { useGetReconciliationsQuery } from "@/lib/accubridge/api/reconciliationApi";
import type { ReconciliationListItem } from "@/lib/accubridge/api/reconciliationApi";
      ...
      <div className="max-w-5xl mx-auto flex flex-col gap-0">
        ...
        <PageHeader
          ...
          actions={
            <button
              type="button"
              onClick={() => router.push("/accubridge/client/transactions/reconciliation/new")}
              style={{
                display: "flex",
                alignItems: "center",
                gap: "8px",
