...
const REPORT_CARDS = [
  {
    href:        "/accubridge/client/reports/pnl",
  ...
  {
    href:        "/accubridge/client/reports/balance",
  ...
  {
    href:        "/accubridge/client/reports/cashflow",
  ...
  {
    href:        "/accubridge/client/reports/download",
