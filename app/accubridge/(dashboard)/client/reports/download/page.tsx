...
import type { ReportPeriod, ReportDateRange, PnLReport, BalanceSheetReport, CashFlowReport } from "@/types/accubridge/reports";
import { getPeriodRange } from "@/lib/accubridge/reports/report-calculations";
import { exportPnLToPDF, exportBalanceSheetToPDF, exportCashFlowToPDF } from "@/lib/accubridge/reports/generate-pdf";
import { exportPnLToCSV, exportPnLToXLSX, exportBalanceSheetToCSV, exportBalanceSheetToXLSX, exportCashFlowToCSV, exportCashFlowToXLSX } from "@/lib/accubridge/reports/generate-excel";
import { useCurrency } from "@/lib/accubridge/currency-context";
import { type SupportedCurrency } from "@/lib/accubridge/currency";
import {
...
const REPORT_META: Record<ReportId, { label: string; icon: React.ReactNode; color: string; viewHref: string }> = {
  pnl:      { label: "Profit & Loss",      icon: <TrendingUp size={18} />, color: BRAND.green,  viewHref: "/accubridge/client/reports/pnl"      },
  balance:  { label: "Balance Sheet",      icon: <DollarSign size={18} />, color: BRAND.accent, viewHref: "/accubridge/client/reports/balance"  },
  cashflow: { label: "Cash Flow Statement",icon: <BarChart3 size={18} />,  color: BRAND.gold,   viewHref: "/accubridge/client/reports/cashflow" },
};
  ...
  return (
    <div className="p-5 md:p-8 text-white">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-4">
          <Link
            href="/accubridge/client/reports"
