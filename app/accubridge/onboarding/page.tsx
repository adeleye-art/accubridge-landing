...
} from "@/lib/accubridge/onboarding";
import { getAuthUserId } from "@/lib/accubridge/auth";
import { EMPTY_ONBOARDING } from "@/types/accubridge/onboarding";
import type {
  OnboardingProgress,
  OnboardingStep,
  Step1Data,
  ...
  Step4Data,
  Step5Data,
} from "@/types/accubridge/onboarding";
...
export default function OnboardingPage() {
  ...
  function handleSkip() {
    ...
    router.push("/accubridge/client/dashboard");
  }
