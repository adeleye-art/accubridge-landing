...
import type { Step4Data } from "@/types/accubridge/onboarding";
import { FormField, FormSelect, StepNav } from "./form-primitives";
import { useUpdateClientFinancialMutation } from "@/lib/accubridge/api/clientApi";
...
export function Step4FinancialSetup({ data, operatingCountry, userId, onComplete, onBack }: Props) {
  ...
  const banks = operatingCountry === "nigeria" ? BANKS_NG
    : operatingCountry === "both" ? Array.from(new Set([...BANKS_UK, ...BANKS_NG]))
    : BANKS_UK;
