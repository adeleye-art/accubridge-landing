...
import { useVerifyPaymentQuery } from "@/lib/accubridge/api/paymentApi";
import { useCreateFundingApplicationMutation, useSubmitFundingApplicationMutation } from "@/lib/accubridge/api/fundingApi";
    ...
    const run = async () => {
      ...
      try {
        if (type === "raffle") {
          ...
          setTimeout(() => router.push("/accubridge/client/funding/raffle"), 2500);
          ...
          setTimeout(() => router.push("/accubridge/client/dashboard"), 2500);
        } else {
          setStatus("success");
      ...
      {status === "error" && (
        <>
          ...
          <div className="flex gap-3">
            ...
            <button
              type="button"
              onClick={() => router.push("/accubridge/client/dashboard")}
